...
export default function Leavemanage() {
    ...
    useEffect(() => {
        document.body.classList.add('common-page', 'leavemanage')
        return () => {
            document.body.classList.remove('common-page', 'leavemanage')
        }
    }, [])
            ...
            <Row className='h-100 h-inner-100'>
                ...
                <Col xs={12} sm={12} md={8} lg={9} xl={9} xxl={10} className='mt-1 mt-md-0'>
                    <div className='cont-wrap mt-2'>
                        <h5 id='top' className='inner-title'><span>Leave Management</span></h5>
                        <Row>
                            <Col xs={12}>
